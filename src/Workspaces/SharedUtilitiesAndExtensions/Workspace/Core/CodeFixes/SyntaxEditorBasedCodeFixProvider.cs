...
internal abstract partial class SyntaxEditorBasedCodeFixProvider(bool supportsFixAll = true) : CodeFixProvider
{
    ...
    /// cref="IFixAllState{TFixAllContext}.CodeActionEquivalenceKey"/> is used.
    /// <para/>
    ...
    /// cref="IFixAllState{TFixAllContext}.CodeActionEquivalenceKey"/>), then <see cref="IncludeDiagnosticDuringFixAll(Diagnostic,
