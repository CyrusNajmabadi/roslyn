...
internal sealed partial class SolutionCompilationState
{
    ...
    /// <para/>
    /// This not intended to be the public API, use Document.WithFrozenSemantics() instead.
    /// </summary>
        ...
        DocumentId documentId, CancellationToken cancellationToken)
    {
        ...
        // technically inaccurate, but we can accept that as the primary purpose of 'frozen' is to get a
        ...
        // frozen snapshot is different as it is a fork that is already allowed to be inaccurate for perf
