...
namespace Microsoft.CodeAnalysis.CSharp.ExpressionEvaluator
{
    internal static class CompilationExtensions
    {
            ...
            RefKind refKind)
        {
            ...
            var bytes = builder.Count > 0 && compilation.HasDynamicEmitAttributes(CSharpBindingDiagnosticBag.Discarded, Location.None)
            ...
            TypeSymbol type)
        {
            ...
            var names = CSharpCompilation.TupleNamesEncoder.TryGetNames(type, builder) && compilation.HasTupleNamesAttributes(CSharpBindingDiagnosticBag.Discarded, Location.None)
