...
internal static class Extensions
{
    ...
    {
        return binder.BindCref(syntax, out ambiguityWinner, new Microsoft.CodeAnalysis.CSharp.CSharpBindingDiagnosticBag(diagnostics));
    }
    ...
    {
        return binder.BindEmbeddedBlock(node, new Microsoft.CodeAnalysis.CSharp.CSharpBindingDiagnosticBag(diagnostics));
    }
    ...
    {
        return binder.BindExpression(node, new Microsoft.CodeAnalysis.CSharp.CSharpBindingDiagnosticBag(diagnostics));
    }
