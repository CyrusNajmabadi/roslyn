        ...
        private void ParseModifiers(SyntaxListBuilder tokens, bool forAccessors, bool forTopLevelStatements, out bool isPossibleTypeDeclaration)
        {
            ...
            while (true)
            {
                ...
                if (newMod == DeclarationModifiers.None)
                {
                    if (!forAccessors)
                    {
                        var scopedKeyword = ParsePossibleScopedKeyword(isFunctionPointerParameter: false);
                ...
                case SyntaxKind.StructKeyword:
                    return _syntaxFactory.ClassOrStructConstraint(
                        ...
                        this.CurrentToken.Kind == SyntaxKind.QuestionToken
                            ? this.AddError(this.EatToken(), ErrorCode.ERR_UnexpectedToken, "?")
                            : null);
                case SyntaxKind.ClassKeyword:
                    return _syntaxFactory.ClassOrStructConstraint(
...
parse_member_name:;
            ...
            bool tryParseLocalDeclarationStatement<DeclarationSyntax>(
                SyntaxList<AttributeListSyntax> attributes,
                [NotNullWhen(true)] out MemberDeclarationSyntax? result) where DeclarationSyntax : StatementSyntax
            {
                bool wasInAsync = IsInAsync;
                IsInAsync = true; // We are implicitly in an async context
                int lastTokenPosition = -1;
            ...
            bool tryParseStatement(
                ...
                [NotNullWhen(true)] out MemberDeclarationSyntax? result)
            {
...
parse_member_name:;
        ...
        private ConversionOperatorDeclarationSyntax? TryParseConversionOperatorDeclaration(SyntaxList<AttributeListSyntax> attributes, SyntaxListBuilder modifiers)
        {
            ...
            try
            {
                ...
                var explicitInterfaceOpt = tryParseExplicitInterfaceSpecifier();
...
tryAgain:
        ...
        private void ParseParameterModifiers(SyntaxListBuilder modifiers, bool isFunctionPointerParameter)
        {
            ...
            if (tryScoped)
            {
                var scopedKeyword = ParsePossibleScopedKeyword(isFunctionPointerParameter);
                if (scopedKeyword != null)
                {
...
tryAgain:
        ...
        private CatchClauseSyntax ParseCatchClause()
        {
            ...
            if (this.CurrentToken.Kind == SyntaxKind.OpenParenToken)
            {
                ...
                var type = this.ParseType();
                var name = this.IsTrueIdentifier()
                    ? this.ParseIdentifierToken()
                    : null;
        ...
        private ForStatementSyntax ParseForStatement(SyntaxList<AttributeListSyntax> attributes)
        {
            ...
            try
            {
                ...
                if (isDeclaration)
                {
                    var scopedKeyword = haveScopedKeyword
                ...
                var condition = this.CurrentToken.Kind != SyntaxKind.SemicolonToken
...
tryAgain:
        ...
        private AnonymousMethodExpressionSyntax ParseAnonymousMethodExpression()
        {
            ...
            AnonymousMethodExpressionSyntax parseAnonymousMethodExpressionWorker()
            {
                ...
                var parameterList = this.CurrentToken.Kind == SyntaxKind.OpenParenToken
                    ? this.ParseParenthesizedParameterList()
                    : null;
...
tryAgain:
        ...
        private ParameterSyntax ParseLambdaParameter()
        {
            ...
            var paramType = hasModifier || ShouldParseLambdaParameterType()
        ...
        private QueryBodySyntax ParseQueryBody()
        {
            ...
            return _syntaxFactory.QueryBody(
                ...
                selectOrGroupBy,
                this.CurrentToken.ContextualKind == SyntaxKind.IntoKeyword ? this.ParseQueryContinuation() : null);
        }
