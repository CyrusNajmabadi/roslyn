...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed partial class DiagnosticsPass
    {
        ...
        public static void IssueDiagnostics(CSharpCompilation compilation, BoundNode node, CSharpBindingDiagnosticBag diagnostics, MethodSymbol containingSymbol)
        {
        ...
        private DiagnosticsPass(CSharpCompilation compilation, CSharpBindingDiagnosticBag diagnostics, MethodSymbol containingSymbol)
        {
