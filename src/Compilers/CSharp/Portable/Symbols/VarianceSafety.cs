...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal static class VarianceSafety
    {
        ...
        /// </summary>
        internal static void CheckInterfaceVarianceSafety(this NamedTypeSymbol interfaceType, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        private static void CheckNestedTypeVarianceSafety(NamedTypeSymbol member, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        internal static void CheckDelegateVarianceSafety(this SourceDelegateMethodSymbol method, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        private static void CheckMethodVarianceSafety(this MethodSymbol method, CSharpBindingDiagnosticBag diagnostics)
        {
            method.CheckMethodVarianceSafety(
                returnTypeLocationProvider: m =>
                    {
        ...
        private static void CheckMethodVarianceSafety(this MethodSymbol method, LocationProvider<MethodSymbol> returnTypeLocationProvider, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        private static void CheckPropertyVarianceSafety(PropertySymbol property, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        private static void CheckEventVarianceSafety(EventSymbol @event, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        private static void CheckParametersVarianceSafety(ImmutableArray<ParameterSymbol> parameters, Symbol context, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        private static void CheckTypeParametersVarianceSafety(ImmutableArray<TypeParameterSymbol> typeParameters, MethodSymbol context, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private static void AddVarianceError<T>(
            this CSharpBindingDiagnosticBag diagnostics,
