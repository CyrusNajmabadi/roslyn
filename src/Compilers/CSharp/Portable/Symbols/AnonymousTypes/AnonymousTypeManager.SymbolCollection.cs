...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal sealed partial class AnonymousTypeManager
    {
        ...
        public bool ReportMissingOrErroneousSymbols(CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        public bool ReportMissingOrErroneousSymbolsForDelegates(CSharpBindingDiagnosticBag diagnostics)
        {
            bool hasErrors = false;
        ...
        private static void ReportErrorOnSymbol(Symbol symbol, CSharpBindingDiagnosticBag diagnostics, ref bool hasError)
        {
        ...
        private static void ReportErrorOnSpecialMember(Symbol symbol, SpecialMember member, CSharpBindingDiagnosticBag diagnostics, ref bool hasError)
        {
            if ((object)symbol == null)
            {
        ...
        private static void ReportErrorOnWellKnownMember(Symbol symbol, WellKnownMember member, CSharpBindingDiagnosticBag diagnostics, ref bool hasError)
        {
            if ((object)symbol == null)
            {
