...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal class SynthesizedInstanceConstructor : SynthesizedInstanceMethodSymbol
    {
        ...
        protected void GenerateMethodBodyCore(TypeCompilationState compilationState, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        internal virtual void GenerateMethodBodyStatements(SyntheticBoundNodeFactory factory, ArrayBuilder<BoundStatement> statements, CSharpBindingDiagnosticBag diagnostics)
        {
