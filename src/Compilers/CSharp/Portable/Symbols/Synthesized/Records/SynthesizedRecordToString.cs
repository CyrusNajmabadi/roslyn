...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal sealed class SynthesizedRecordToString : SynthesizedRecordObjectMethod
    {
        ...
        public SynthesizedRecordToString(SourceMemberContainerTypeSymbol containingType, MethodSymbol printMethod, int memberOffset, bool isReadOnly, CSharpBindingDiagnosticBag diagnostics)
            : base(
                  containingType,
