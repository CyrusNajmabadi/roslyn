...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    {
        protected SynthesizedRecordObjectMethod(SourceMemberContainerTypeSymbol containingType, string name, int memberOffset, bool isReadOnly, CSharpBindingDiagnosticBag diagnostics)
            : base(containingType, name, isReadOnly: isReadOnly, hasBody: true, memberOffset, diagnostics)
        {
        }

        protected sealed override DeclarationModifiers MakeDeclarationModifiers(DeclarationModifiers allowedModifiers, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        protected sealed override void MethodChecks(CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        internal static bool VerifyOverridesMethodFromObject(MethodSymbol overriding, SpecialMember overriddenSpecialMember, CSharpBindingDiagnosticBag diagnostics)
        {
