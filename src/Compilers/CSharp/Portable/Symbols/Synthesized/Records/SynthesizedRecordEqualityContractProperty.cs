...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal sealed class SynthesizedRecordEqualityContractProperty : SourcePropertySymbolBase
    {
        ...
        public SynthesizedRecordEqualityContractProperty(SourceMemberContainerTypeSymbol containingType, CSharpBindingDiagnosticBag diagnostics)
            : base(
                containingType,
        ...
        protected override void ValidatePropertyType(CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        internal static void VerifyOverridesEqualityContractFromBase(PropertySymbol overriding, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        internal sealed class GetAccessorSymbol : SourcePropertyAccessorSymbol
        {
            ...
            internal override void GenerateMethodBody(TypeCompilationState compilationState, CSharpBindingDiagnosticBag diagnostics)
            {
