...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal abstract class SynthesizedParameterSymbolBase : ParameterSymbol
    {
        ...
        internal override void AddSynthesizedAttributes(PEModuleBuilder moduleBuilder, ref ArrayBuilder<SynthesizedAttributeData> attributes)
        {
            ...
            if (type.Type.ContainsDynamic() && compilation.HasDynamicEmitAttributes(CSharpBindingDiagnosticBag.Discarded, Location.None) && compilation.CanEmitBoolean())
            {
            ...
            if (type.Type.ContainsTupleNames() &&
                compilation.HasTupleNamesAttributes(CSharpBindingDiagnosticBag.Discarded, Location.None) &&
