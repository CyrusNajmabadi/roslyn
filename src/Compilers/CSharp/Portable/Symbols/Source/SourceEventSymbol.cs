...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal abstract class SourceEventSymbol : EventSymbol, IAttributeTargetSymbol
    {
        ...
        private DeclarationModifiers MakeModifiers(SyntaxTokenList modifiers, bool explicitInterfaceImplementation,
                                                   ...
                                                   CSharpBindingDiagnosticBag diagnostics, out bool modifierErrors)
        {
        ...
        protected void CheckModifiersAndType(CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        protected TypeWithAnnotations BindEventType(Binder binder, TypeSyntax typeSyntax, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private void CheckExplicitImplementationAccessor(MethodSymbol? thisAccessor, MethodSymbol? otherAccessor, EventSymbol explicitlyImplementedEvent, CSharpBindingDiagnosticBag diagnostics)
        {
