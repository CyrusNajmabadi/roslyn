...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal sealed class SourceCustomEventSymbol : SourceEventSymbol
    {
        ...
        internal SourceCustomEventSymbol(SourceMemberContainerTypeSymbol containingType, Binder binder, EventDeclarationSyntax syntax, CSharpBindingDiagnosticBag diagnostics) :
        ...
        private SourceCustomEventAccessorSymbol? CreateAccessorSymbol(CSharpCompilation compilation, AccessorDeclarationSyntax? syntaxOpt,
            EventSymbol? explicitlyImplementedEventOpt, string? aliasQualifierOpt, CSharpBindingDiagnosticBag diagnostics)
        {
            if (syntaxOpt == null)
            {
                return null;
