...
#nullable disable
        ...
        protected static DeclarationModifiers MakeDeclarationModifiers(MethodKind methodKind, bool inInterface, BaseMethodDeclarationSyntax syntax, Location location, CSharpBindingDiagnosticBag diagnostics)
        {
            ...
            static void reportModifierIfPresent(DeclarationModifiers result, DeclarationModifiers errorModifier, Location location, CSharpBindingDiagnosticBag diagnostics, CSharpRequiredLanguageVersion requiredVersionArgument, string availableVersionArgument)
            {
        ...
        protected (TypeWithAnnotations ReturnType, ImmutableArray<ParameterSymbol> Parameters) MakeParametersAndBindReturnType(BaseMethodDeclarationSyntax declarationSyntax, TypeSyntax returnTypeSyntax, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        protected override void MethodChecks(CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        protected abstract (TypeWithAnnotations ReturnType, ImmutableArray<ParameterSymbol> Parameters) MakeParametersAndBindReturnType(CSharpBindingDiagnosticBag diagnostics);

        protected sealed override void ExtensionMethodChecks(CSharpBindingDiagnosticBag diagnostics)
        {
        }

        protected sealed override MethodSymbol FindExplicitlyImplementedMethod(CSharpBindingDiagnosticBag diagnostics)
        {
...
#nullable disable
        ...
        private void CheckValueParameters(CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private void CheckOperatorSignatures(CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private void CheckUserDefinedConversionSignature(CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private void CheckReturnIsNotVoid(CSharpBindingDiagnosticBag diagnostics)
        {
            if (this.ReturnsVoid)
            {
        ...
        private void CheckUnarySignature(CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private void CheckTrueFalseSignature(CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private void CheckIncrementDecrementSignature(CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private void CheckShiftSignature(CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private void CheckBinarySignature(CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private void CheckAbstractEqualitySignature(CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        protected sealed override void CheckConstraintsForExplicitInterfaceType(ConversionsBase conversions, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        protected sealed override void PartialMethodChecks(CSharpBindingDiagnosticBag diagnostics)
        {
        }
    }
}
