...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    {
        internal static SourcePropertySymbol Create(SourceMemberContainerTypeSymbol containingType, Binder bodyBinder, PropertyDeclarationSyntax syntax, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        internal static SourcePropertySymbol Create(SourceMemberContainerTypeSymbol containingType, Binder bodyBinder, IndexerDeclarationSyntax syntax, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        protected override SourcePropertyAccessorSymbol CreateGetAccessorSymbol(bool isAutoPropertyAccessor, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        protected override SourcePropertyAccessorSymbol CreateSetAccessorSymbol(bool isAutoPropertyAccessor, CSharpBindingDiagnosticBag diagnostics)
        {
            var syntax = (BasePropertyDeclarationSyntax)CSharpSyntaxNode;
        ...
        protected override (TypeWithAnnotations Type, ImmutableArray<ParameterSymbol> Parameters) MakeParametersAndBindType(CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private TypeWithAnnotations ComputeType(Binder binder, SyntaxNode syntax, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private static ImmutableArray<ParameterSymbol> MakeParameters(
            Binder binder, SourcePropertySymbolBase owner, BaseParameterListSyntax? parameterSyntaxOpt, CSharpBindingDiagnosticBag diagnostics, bool addRefReadOnlyModifier)
        {
        ...
        private ImmutableArray<ParameterSymbol> ComputeParameters(Binder binder, CSharpSyntaxNode syntax, CSharpBindingDiagnosticBag diagnostics)
        {
