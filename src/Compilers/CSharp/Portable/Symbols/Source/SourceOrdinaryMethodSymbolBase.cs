...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal abstract class SourceOrdinaryMethodSymbolBase : SourceOrdinaryMethodOrUserDefinedOperatorSymbol
    {
        ...
        protected abstract ImmutableArray<TypeParameterSymbol> MakeTypeParameters(CSharpSyntaxNode node, CSharpBindingDiagnosticBag diagnostics);
...
#nullable disable
        ...
        protected abstract (TypeWithAnnotations ReturnType, ImmutableArray<ParameterSymbol> Parameters, bool IsVararg, ImmutableArray<TypeParameterConstraintClause> DeclaredConstraintsForOverrideOrImplementation) MakeParametersAndBindReturnType(CSharpBindingDiagnosticBag diagnostics);
        ...
        private void CompleteAsyncMethodChecks(CSharpBindingDiagnosticBag diagnosticsOpt, CancellationToken cancellationToken)
        {
        ...
        private (DeclarationModifiers mods, bool hasExplicitAccessMod) MakeModifiers(MethodKind methodKind, bool isReadOnly, bool hasBody, Location location, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        protected abstract DeclarationModifiers MakeDeclarationModifiers(DeclarationModifiers allowedModifiers, CSharpBindingDiagnosticBag diagnostics);
        ...
        private void CheckModifiers(bool isExplicitInterfaceImplementation, bool isVararg, bool hasBody, Location location, CSharpBindingDiagnosticBag diagnostics)
        {
