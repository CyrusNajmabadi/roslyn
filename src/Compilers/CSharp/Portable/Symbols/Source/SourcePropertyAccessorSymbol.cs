...
#nullable disable
        ...
        private TypeWithAnnotations ComputeReturnType(CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private DeclarationModifiers MakeModifiers(SyntaxTokenList modifiers, bool isExplicitInterfaceImplementation,
            bool hasBody, Location location, CSharpBindingDiagnosticBag diagnostics, out bool modifierErrors)
        {
        ...
        private void CheckModifiers(Location location, bool hasBody, bool isAutoPropertyOrExpressionBodied, CSharpBindingDiagnosticBag diagnostics)
        {
