...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal abstract class SourceMethodSymbol : MethodSymbol
    {
        ...
        protected static void ReportBadRefToken(TypeSyntax returnTypeSyntax, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        internal void ReportAsyncParameterErrors(CSharpBindingDiagnosticBag diagnostics, Location location)
        {
