...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal static class ExplicitInterfaceHelpers
    {
            ...
            string name)
        {
            ...
            string methodName = GetMemberNameAndInterfaceSymbol(binder, explicitInterfaceSpecifierOpt, name, CSharpBindingDiagnosticBag.Discarded, out discardedExplicitInterfaceType, out discardedAliasOpt);
...
#nullable disable
        ...
        /// </summary>
        private static void FindExplicitImplementationCollisions(Symbol implementingMember, Symbol implementedMember, CSharpBindingDiagnosticBag diagnostics)
        {
            if ((object)implementedMember == null)
            {
                return;
