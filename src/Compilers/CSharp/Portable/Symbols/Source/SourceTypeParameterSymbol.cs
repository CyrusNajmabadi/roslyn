...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal abstract class SourceTypeParameterSymbolBase : TypeParameterSymbol, IAttributeTargetSymbol
    {
        ...
        protected abstract TypeParameterBounds ResolveBounds(ConsList<TypeParameterSymbol> inProgress, CSharpBindingDiagnosticBag diagnostics);
        ...
        /// </summary>
        private void CheckConstraintTypeConstraints(CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private void CheckUnmanagedConstraint(CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private void EnsureAttributesFromConstraints(CSharpBindingDiagnosticBag diagnostics)
        {
    ...
    internal sealed class SourceTypeParameterSymbol : SourceTypeParameterSymbolBase
    {
        ...
        protected override TypeParameterBounds ResolveBounds(ConsList<TypeParameterSymbol> inProgress, CSharpBindingDiagnosticBag diagnostics)
        {
