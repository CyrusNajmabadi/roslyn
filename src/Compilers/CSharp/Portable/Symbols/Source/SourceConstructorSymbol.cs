...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal sealed class SourceConstructorSymbol : SourceConstructorSymbolBase
    {
        ...
        private DeclarationModifiers MakeModifiers(SyntaxTokenList modifiers, MethodKind methodKind, bool hasBody, Location location, CSharpBindingDiagnosticBag diagnostics, out bool modifierErrors)
        {
        ...
        private void CheckModifiers(MethodKind methodKind, bool hasBody, Location location, CSharpBindingDiagnosticBag diagnostics)
        {
            if (!hasBody && !IsExtern)
            {
