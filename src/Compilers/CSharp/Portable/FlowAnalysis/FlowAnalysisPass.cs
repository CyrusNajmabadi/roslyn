...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal class FlowAnalysisPass
    {
        ...
        private static BoundBlock PrependImplicitInitializations(BoundBlock body, MethodSymbol method, ImmutableArray<FieldSymbol> implicitlyInitializedFields, TypeCompilationState compilationState, CSharpBindingDiagnosticBag diagnostics)
        {
