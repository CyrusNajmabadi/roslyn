...
#nullable disable
        ...
        {
            return GetEmbeddedTypes(BindingDiagnosticBag.CreateNewInstance(diagnostics));
        }

        internal virtual ImmutableArray<NamedTypeSymbol> GetEmbeddedTypes(CSharpBindingDiagnosticBag diagnostics)
        {
