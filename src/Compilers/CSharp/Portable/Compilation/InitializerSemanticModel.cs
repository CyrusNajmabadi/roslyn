...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed class InitializerSemanticModel : MemberSemanticModel
    {
        ...
        internal override BoundNode Bind(Binder binder, CSharpSyntaxNode node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundEqualsValue BindEqualsValue(Binder binder, EqualsValueClauseSyntax equalsValue, CSharpBindingDiagnosticBag diagnostics)
        {
