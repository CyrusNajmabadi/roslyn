...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class Binder
    {
        ...
        internal BoundAttribute BindAttribute(AttributeSyntax node, NamedTypeSymbol attributeType, Symbol? attributedMember, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundAttribute BindAttributeCore(AttributeSyntax node, NamedTypeSymbol attributeType, Symbol? attributedMember, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private CSharpAttributeData GetAttribute(BoundAttribute boundAttribute, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private void ValidateTypeForAttributeParameters(ImmutableArray<ParameterSymbol> parameters, CSharpSyntaxNode syntax, CSharpBindingDiagnosticBag diagnostics, ref bool hasErrors)
        {
        ...
        private BoundAssignmentOperator BindNamedAttributeArgument(AttributeArgumentSyntax namedArgument, NamedTypeSymbol attributeType, CSharpBindingDiagnosticBag diagnostics)
        {
            bool wasError;
        ...
        private Symbol BindNamedAttributeArgumentName(AttributeArgumentSyntax namedArgument, NamedTypeSymbol attributeType, CSharpBindingDiagnosticBag diagnostics, out bool wasError, out LookupResultKind resultKind)
        {
            RoslynDebug.Assert(namedArgument.NameEquals is object);
        ...
        private TypeSymbol BindNamedAttributeArgumentType(AttributeArgumentSyntax namedArgument, Symbol namedArgumentNameSymbol, NamedTypeSymbol attributeType, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private readonly struct AttributeExpressionVisitor
        {
            ...
            public ImmutableArray<TypedConstant> VisitArguments(ImmutableArray<BoundExpression> arguments, CSharpBindingDiagnosticBag diagnostics, ref bool attrHasErrors, bool parentHasErrors = false)
            {
            ...
            public ImmutableArray<KeyValuePair<string, TypedConstant>> VisitNamedArguments(ImmutableArray<BoundAssignmentOperator> arguments, CSharpBindingDiagnosticBag diagnostics, ref bool attrHasErrors)
            {
            ...
            private KeyValuePair<String, TypedConstant>? VisitNamedArgument(BoundAssignmentOperator assignment, CSharpBindingDiagnosticBag diagnostics, ref bool attrHasErrors)
            {
            ...
            private TypedConstant VisitExpression(BoundExpression node, CSharpBindingDiagnosticBag diagnostics, ref bool attrHasErrors, bool curArgumentHasErrors)
            {
            ...
            private TypedConstant VisitExpression(BoundExpression node, TypedConstantKind typedConstantKind, CSharpBindingDiagnosticBag diagnostics, ref bool attrHasErrors, bool curArgumentHasErrors)
            {
            ...
            private TypedConstant VisitConversion(BoundConversion node, CSharpBindingDiagnosticBag diagnostics, ref bool attrHasErrors, bool curArgumentHasErrors)
            {
            ...
            private static TypedConstant VisitTypeOfExpression(BoundTypeOfOperator node, CSharpBindingDiagnosticBag diagnostics, ref bool attrHasErrors, bool curArgumentHasErrors)
            {
            ...
            private TypedConstant VisitArrayCreation(BoundArrayCreation node, CSharpBindingDiagnosticBag diagnostics, ref bool attrHasErrors, bool curArgumentHasErrors)
            {
            ...
            private static TypedConstant CreateTypedConstant(BoundExpression node, TypedConstantKind typedConstantKind, CSharpBindingDiagnosticBag diagnostics, ref bool attrHasErrors, bool curArgumentHasErrors,
