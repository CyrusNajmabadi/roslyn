...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal partial class Binder
    {
        ...
        /// </summary>
        internal BoundExpression BindValue(ExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics, BindValueKind valueKind)
        {
            var result = this.BindExpression(node, diagnostics: diagnostics, invoked: false, indexed: false);
            return CheckValue(result, valueKind, diagnostics);
        }

        internal BoundExpression BindRValueWithoutTargetType(ExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics, bool reportNoTargetType = true)
        {
        ...
        /// </summary>
        internal BoundExpression BindTypeOrRValue(ExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        internal BoundExpression BindToNaturalType(BoundExpression expression, CSharpBindingDiagnosticBag diagnostics, bool reportNoTargetType = true)
        {
        ...
        private BoundExpression BindToInferredDelegateType(BoundExpression expr, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        internal BoundExpression BindValueAllowArgList(ExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics, BindValueKind valueKind)
        {
        ...
        public BoundExpression BindExpression(ExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            return BindExpression(node, diagnostics: diagnostics, invoked: false, indexed: false);
        }

        protected BoundExpression BindExpression(ExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics, bool invoked, bool indexed)
        {
        ...
        protected BoundExpression BindExpressionAllowArgList(ExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private void VerifyUnchecked(ExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics, BoundExpression expr)
        {
        ...
        private BoundExpression BindExpressionInternal(ExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics, bool invoked, bool indexed)
        {
...
#nullable enable
        internal virtual BoundSwitchExpressionArm BindSwitchExpressionArm(SwitchExpressionArmSyntax node, TypeSymbol switchGoverningType, CSharpBindingDiagnosticBag diagnostics)
        {
            return this.NextRequired.BindSwitchExpressionArm(node, switchGoverningType, diagnostics);
        }
#nullable disable

        private BoundExpression BindRefExpression(ExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindRefType(ExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            var firstToken = node.GetFirstToken();
            diagnostics.Add(ErrorCode.ERR_UnexpectedToken, firstToken.GetLocation(), firstToken.ValueText);
        ...
        private BoundExpression BindScopedType(ExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            var firstToken = node.GetFirstToken();
            diagnostics.Add(ErrorCode.ERR_UnexpectedToken, firstToken.GetLocation(), firstToken.ValueText);
        ...
        private BoundExpression BindThrowExpression(ThrowExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindDeclarationExpressionAsError(DeclarationExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        private BoundExpression BindDeclarationVariablesForErrorRecovery(TypeWithAnnotations declTypeWithAnnotations, VariableDesignationSyntax node, CSharpSyntaxNode syntax, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindTupleExpression(TupleExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindRefValue(RefValueExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindMakeRef(MakeRefExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindRefType(RefTypeExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindArgList(CSharpSyntaxNode node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        private BoundExpression BindQualifiedName(QualifiedNameSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindParenthesizedExpression(ExpressionSyntax innerExpression, CSharpBindingDiagnosticBag diagnostics)
        {
...
#nullable enable
        private BoundExpression BindTypeOf(TypeOfExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private void CheckDisallowedAttributeDependentType(TypeWithAnnotations typeArgument, NameSyntax attributeName, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindSizeOf(SizeOfExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            ExpressionSyntax typeSyntax = node.Type;
            AliasSymbol alias;
        ...
        internal static bool CheckManagedAddr(CSharpCompilation compilation, TypeSymbol type, Location location, CSharpBindingDiagnosticBag diagnostics, bool errorForManaged = false)
        {
        ...
        /// <returns>true if managed type-related errors were found, otherwise false.</returns>
        internal static bool CheckManagedAddr(CSharpCompilation compilation, TypeSymbol type, ManagedKind managedKind, Location location, CSharpBindingDiagnosticBag diagnostics, bool errorForManaged = false)
        {
            switch (managedKind)
            {
...
#nullable disable
        ...
        private BoundExpression BindDefaultExpression(DefaultExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        private static bool FallBackOnDiscard(IdentifierNameSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindNonMethod(SimpleNameSyntax node, Symbol symbol, CSharpBindingDiagnosticBag diagnostics, LookupResultKind resultKind, bool indexed, bool isError)
        {
        ...
        private bool ReportSimpleProgramLocalReferencedOutsideOfTopLevelStatement(SimpleNameSyntax node, Symbol symbol, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        protected virtual BoundExpression BindRangeVariable(SimpleNameSyntax node, RangeVariableSymbol qv, CSharpBindingDiagnosticBag diagnostics)
        {
            return Next.BindRangeVariable(node, qv, diagnostics);
        }

        private BoundExpression SynthesizeReceiver(SyntaxNode node, Symbol member, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        public BoundExpression BindNamespaceOrTypeOrExpression(ExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        public BoundExpression BindLabel(ExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        public BoundExpression BindNamespaceOrType(ExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        public BoundExpression BindNamespaceAlias(IdentifierNameSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundThisReference BindThis(ThisExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            Debug.Assert(node != null);
            bool hasErrors = true;
...
#nullable enable
        private bool IsRefOrOutThisParameterCaptured(SyntaxNodeOrToken thisOrBaseToken, CSharpBindingDiagnosticBag diagnostics)
        {
...
#nullable disable
        ...
        private BoundBaseReference BindBase(BaseExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            bool hasErrors = false;
        ...
        private BoundExpression BindCast(CastExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindFromEndIndexExpression(PrefixUnaryExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindRangeExpression(RangeExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindRangeExpressionOperand(ExpressionSyntax operand, CSharpBindingDiagnosticBag diagnostics)
        {
            if (operand is null)
            {
                return null;
        ...
        private BoundExpression BindCastCore(ExpressionSyntax node, BoundExpression operand, TypeWithAnnotations targetTypeWithAnnotations, bool wasCompilerGenerated, CSharpBindingDiagnosticBag diagnostics)
        {
            TypeSymbol targetType = targetTypeWithAnnotations.Type;
            CompoundUseSiteInfo<AssemblySymbol> useSiteInfo = GetNewCompoundUseSiteInfo(diagnostics);
        ...
        /// </summary>
        private BoundExpression BindExplicitNullableCastFromNonNullable(ExpressionSyntax node, BoundExpression operand, TypeWithAnnotations targetTypeWithAnnotations, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        // arguments.
        private void BindArgumentsAndNames(BaseArgumentListSyntax argumentListOpt, CSharpBindingDiagnosticBag diagnostics, AnalyzedArguments result, bool allowArglist = false, bool isDelegateCreation = false)
        {
        ...
        private BoundExpression BindArgumentValue(CSharpBindingDiagnosticBag diagnostics, ArgumentSyntax argumentSyntax, bool allowArglist, RefKind refKind)
        {
        ...
        private BoundExpression BindOutDeclarationArgument(DeclarationExpressionSyntax declarationExpression, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        internal static void CheckRestrictedTypeInAsyncMethod(Symbol containingSymbol, TypeSymbol type, CSharpBindingDiagnosticBag diagnostics, SyntaxNode syntax, bool forUsingExpression = false)
        {
        ...
        /// </summary>
        private BoundExpression BindArgumentExpression(CSharpBindingDiagnosticBag diagnostics, ExpressionSyntax argumentExpression, RefKind refKind, bool allowArglist)
        {
            BindValueKind valueKind =
...
#nullable enable
            ...
            where TMember : Symbol
        {
            ...
            void reportUnsafeIfNeeded(MemberResolutionResult<TMember> methodResult, CSharpBindingDiagnosticBag diagnostics, BoundExpression argument, TypeWithAnnotations parameterTypeWithAnnotations)
            {
...
#nullable disable
        ...
        private BoundExpression BindArrayCreationExpression(ArrayCreationExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            // SPEC begins
            //
        ...
        private BoundExpression BindArrayDimension(ExpressionSyntax dimension, CSharpBindingDiagnosticBag diagnostics, ref bool hasErrors)
        {
        ...
        private BoundExpression BindImplicitArrayCreationExpression(ImplicitArrayCreationExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindImplicitStackAllocArrayCreationExpression(ImplicitStackAllocArrayCreationExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            InitializerExpressionSyntax initializer = node.Initializer;
        ...
        private ImmutableArray<BoundExpression> BindArrayInitializerExpressions(InitializerExpressionSyntax initializer, CSharpBindingDiagnosticBag diagnostics, int dimension, int rank)
        {
        ...
        private void BindArrayInitializerExpressions(InitializerExpressionSyntax initializer, ArrayBuilder<BoundExpression> exprBuilder, CSharpBindingDiagnosticBag diagnostics, int dimension, int rank)
        {
            Debug.Assert(rank > 0);
        ...
        private BoundExpression BindStackAllocArrayCreationExpression(
            StackAllocArrayCreationExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private bool ReportBadStackAllocPosition(SyntaxNode node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private TypeSymbol GetStackAllocType(SyntaxNode node, TypeWithAnnotations elementTypeWithAnnotations, CSharpBindingDiagnosticBag diagnostics, out bool hasErrors)
        {
            ...
            CSharpBindingDiagnosticBag diagnostics)
        {
            ...
            static void validateRecordCopyConstructor(MethodSymbol constructor, NamedTypeSymbol baseType, MethodSymbol resultMember, Location errorLocation, CSharpBindingDiagnosticBag diagnostics)
            {
        ...
        private BoundExpression BindImplicitObjectCreationExpression(ImplicitObjectCreationExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        protected BoundExpression BindObjectCreationExpression(ObjectCreationExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            ...
            BoundExpression bindObjectCreationExpression(ObjectCreationExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
            {
        ...
        private BoundExpression BindDelegateCreationExpression(ObjectCreationExpressionSyntax node, NamedTypeSymbol type, CSharpBindingDiagnosticBag diagnostics)
        {
            AnalyzedArguments analyzedArguments = AnalyzedArguments.GetInstance();
        ...
        private BoundExpression BindDelegateCreationExpression(SyntaxNode node, NamedTypeSymbol type, AnalyzedArguments analyzedArguments, InitializerExpressionSyntax initializerOpt, bool wasTargetTyped, CSharpBindingDiagnosticBag diagnostics)
        {
            bool hasErrors = false;
        ...
        private BoundExpression BindClassCreationExpression(ObjectCreationExpressionSyntax node, NamedTypeSymbol type, string typeName, CSharpBindingDiagnosticBag diagnostics, TypeSymbol initializerType = null)
        {
            // Get the bound arguments and the argument names.
            AnalyzedArguments analyzedArguments = AnalyzedArguments.GetInstance();
            try
...
#nullable enable
        ...
        internal BoundExpression BindObjectCreationForErrorRecovery(BoundUnconvertedObjectCreationExpression node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression MakeBadExpressionForObjectCreation(ObjectCreationExpressionSyntax node, TypeSymbol type, AnalyzedArguments analyzedArguments, CSharpBindingDiagnosticBag diagnostics, bool wasCompilerGenerated = false)
        {
        ...
        private BoundExpression MakeBadExpressionForObjectCreation(SyntaxNode node, TypeSymbol type, AnalyzedArguments analyzedArguments, InitializerExpressionSyntax? initializerOpt, SyntaxNode? typeSyntax, CSharpBindingDiagnosticBag diagnostics, bool wasCompilerGenerated = false)
        {
...
#nullable disable
        ...
        private static void ReportDuplicateObjectMemberInitializers(BoundExpression boundMemberInitializer, HashSet<string> memberNameMap, CSharpBindingDiagnosticBag diagnostics)
        {
...
#nullable disable
        ...
        private bool CollectionInitializerTypeImplementsIEnumerable(TypeSymbol initializerType, CSharpSyntaxNode node, CSharpBindingDiagnosticBag diagnostics)
        {
            // SPEC:    The collection object to which a collection initializer is applied must be of a type that implements System.Collections.IEnumerable or
            // SPEC:    a compile-time error occurs.
        ...
        private BoundExpression BindUnexpectedComplexElementInitializer(InitializerExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindInterfaceCreationExpression(ObjectCreationExpressionSyntax node, NamedTypeSymbol type, CSharpBindingDiagnosticBag diagnostics)
        {
            AnalyzedArguments analyzedArguments = AnalyzedArguments.GetInstance();
        ...
        private BoundExpression BindInterfaceCreationExpression(SyntaxNode node, NamedTypeSymbol type, CSharpBindingDiagnosticBag diagnostics, SyntaxNode typeNode, AnalyzedArguments analyzedArguments, InitializerExpressionSyntax initializerOpt, bool wasTargetTyped)
        {
            Debug.Assert((object)type != null);
        ...
        private BoundExpression BindComImportCoClassCreationExpression(SyntaxNode node, NamedTypeSymbol interfaceType, NamedTypeSymbol coClassType, CSharpBindingDiagnosticBag diagnostics, SyntaxNode typeNode, AnalyzedArguments analyzedArguments, InitializerExpressionSyntax initializerOpt, bool wasTargetTyped)
        {
        ...
        private BoundExpression BindTypeParameterCreationExpression(ObjectCreationExpressionSyntax node, TypeParameterSymbol typeParameter, CSharpBindingDiagnosticBag diagnostics)
        {
            AnalyzedArguments analyzedArguments = AnalyzedArguments.GetInstance();
            BindArgumentsAndNames(node.ArgumentList, diagnostics, analyzedArguments);
        ...
        private BoundExpression BindTypeParameterCreationExpression(
            ...
            SyntaxNode typeSyntax, bool wasTargetTyped, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        internal static bool ReportConstructorUseSiteDiagnostics(Location errorLocation, CSharpBindingDiagnosticBag diagnostics, bool suppressUnsupportedRequiredMembersError, CompoundUseSiteInfo<AssemblySymbol> useSiteInfo)
        {
        ...
        private BoundLiteral BindLiteralConstant(LiteralExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundUtf8String BindUtf8StringLiteral(LiteralExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindCheckedExpression(CheckedExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        private BoundExpression BindLeftOfPotentialColorColorMemberAccess(ExpressionSyntax left, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindLeftIdentifierOfPotentialColorColorMemberAccess(IdentifierNameSyntax left, CSharpBindingDiagnosticBag diagnostics)
        {
            ...
            var valueDiagnostics = CSharpBindingDiagnosticBag.Create(diagnostics);
            ...
            if ((object)leftSymbol != null)
            {
                switch (leftSymbol.Kind)
                {
                    ...
                    case SymbolKind.RangeVariable:
                        ...
                        {
                            var typeDiagnostics = CSharpBindingDiagnosticBag.Create(diagnostics);
        ...
        /// <see cref="MakeQueryInvocation(CSharpSyntaxNode, BoundExpression, string, TypeSyntax, TypeWithAnnotations, CSharpBindingDiagnosticBag, string)"/>.
        /// </remarks>
#else
        /// <summary>
        /// Bind the RHS of a member access expression, given the bound LHS.
        ...
        private void WarnOnAccessOfOffDefault(SyntaxNode node, BoundExpression boundLeft, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        private BoundExpression MakeMemberAccessValue(BoundExpression expr, CSharpBindingDiagnosticBag diagnostics)
        {
            switch (expr.Kind)
            {
                case BoundKind.MethodGroup:
        ...
        private void BindMemberAccessReportError(BoundMethodGroup node, CSharpBindingDiagnosticBag diagnostics)
        {
...
#nullable disable
        ...
        private void CheckReceiverAndRuntimeSupportForSymbolAccess(SyntaxNode node, BoundExpression receiverOpt, Symbol symbol, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        private Symbol GetSymbolOrMethodOrPropertyGroup(LookupResult result, SyntaxNode node, string plainName, int arity, ArrayBuilder<Symbol> methodOrPropertyGroup, CSharpBindingDiagnosticBag diagnostics, out bool wasError, NamespaceOrTypeSymbol qualifierOpt)
        {
        ...
        private BoundExpression BindElementAccess(ElementAccessExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindElementAccess(ExpressionSyntax node, BoundExpression receiver, BracketedArgumentListSyntax argumentList, CSharpBindingDiagnosticBag diagnostics)
        {
            AnalyzedArguments analyzedArguments = AnalyzedArguments.GetInstance();
            try
            {
        ...
        private BoundExpression BindElementOrIndexerAccess(ExpressionSyntax node, BoundExpression expr, AnalyzedArguments analyzedArguments, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BadIndexerExpression(SyntaxNode node, BoundExpression expr, AnalyzedArguments analyzedArguments, DiagnosticInfo errorOpt, CSharpBindingDiagnosticBag diagnostics)
        {
            if (!expr.HasAnyErrors)
            {
        ...
        private BoundExpression BindArrayAccess(SyntaxNode node, BoundExpression expr, AnalyzedArguments arguments, CSharpBindingDiagnosticBag diagnostics)
        {
            Debug.Assert(node != null);
            Debug.Assert(expr != null);
            Debug.Assert(arguments != null);
        ...
        private BoundExpression ConvertToArrayIndex(BoundExpression index, CSharpBindingDiagnosticBag diagnostics, bool allowIndexAndRange, out WellKnownType indexOrRangeWellknownType)
        {
        ...
        private BoundExpression TryImplicitConversionToArrayIndex(BoundExpression expr, WellKnownType wellKnownType, SyntaxNode node, CSharpBindingDiagnosticBag diagnostics)
        {
            CompoundUseSiteInfo<AssemblySymbol> useSiteInfo = GetNewCompoundUseSiteInfo(diagnostics);
        ...
        private BoundExpression TryImplicitConversionToArrayIndex(BoundExpression expr, TypeSymbol targetType, SyntaxNode node, CSharpBindingDiagnosticBag diagnostics)
        {
            Debug.Assert(expr != null);
        ...
        private BoundExpression BindPointerElementAccess(SyntaxNode node, BoundExpression expr, AnalyzedArguments analyzedArguments, CSharpBindingDiagnosticBag diagnostics)
        {
            Debug.Assert(node != null);
            Debug.Assert(expr != null);
        ...
        private static bool ReportRefOrOutArgument(AnalyzedArguments analyzedArguments, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindIndexerAccess(SyntaxNode node, BoundExpression expr, AnalyzedArguments analyzedArguments, CSharpBindingDiagnosticBag diagnostics)
        {
            Debug.Assert(node != null);
            Debug.Assert(expr != null);
            Debug.Assert((object)expr.Type != null);
        ...
        private BoundExpression BindIndexedPropertyAccess(BoundPropertyGroup propertyGroup, bool mustHaveAllOptionalParameters, CSharpBindingDiagnosticBag diagnostics)
        {
...
#nullable enable
        private BoundExpression BindIndexedPropertyAccess(SyntaxNode syntax, BoundExpression receiver, ImmutableArray<PropertySymbol> propertyGroup, AnalyzedArguments arguments, CSharpBindingDiagnosticBag diagnostics)
        {
            Debug.Assert(receiver is not null);
...
#nullable enable
            ...
            CSharpBindingDiagnosticBag diagnostics)
        {
            ...
            bool tryLookupLengthOrCount(SyntaxNode syntax, string propertyName, [NotNullWhen(true)] out PropertySymbol? valid, CSharpBindingDiagnosticBag diagnostics)
            {
                var useSiteInfo = GetNewCompoundUseSiteInfo(diagnostics);
                LookupMembersInType(
                    lookupResult,
...
#nullable disable
        ...
        internal static bool ReportDelegateInvokeUseSiteDiagnostic(CSharpBindingDiagnosticBag diagnostics, TypeSymbol possibleDelegateType,
        ...
        private BoundConditionalAccess BindConditionalAccessExpression(ConditionalAccessExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundConditionalAccess GenerateBadConditionalAccessNodeError(ConditionalAccessExpressionSyntax node, BoundExpression receiver, BoundExpression access, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindMemberBindingExpression(MemberBindingExpressionSyntax node, bool invoked, bool indexed, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindElementBindingExpression(ElementBindingExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            BoundExpression receiver = GetReceiverForConditionalBinding(node, diagnostics);
        ...
        private BoundExpression GetReceiverForConditionalBinding(ExpressionSyntax binding, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression BindConditionalAccessReceiver(ConditionalAccessExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
