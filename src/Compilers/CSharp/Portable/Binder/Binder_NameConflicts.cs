...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    {
        private bool ValidateLambdaParameterNameConflictsInScope(Location location, string name, CSharpBindingDiagnosticBag diagnostics)
        {
            return ValidateNameConflictsInScope(null, location, name, diagnostics);
        }

        internal bool ValidateDeclarationNameConflictsInScope(Symbol symbol, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </remarks>
        private bool ValidateNameConflictsInScope(Symbol? symbol, Location location, string name, CSharpBindingDiagnosticBag diagnostics)
        {
            if (string.IsNullOrEmpty(name))
            {
                return false;
