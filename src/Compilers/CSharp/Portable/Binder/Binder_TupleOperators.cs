...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class Binder
    {
        ...
        private BoundTupleBinaryOperator BindTupleBinaryOperator(BinaryExpressionSyntax node, BinaryOperatorKind kind,
            BoundExpression left, BoundExpression right, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundExpression ApplyConvertedTypes(BoundExpression expr, TupleBinaryOperatorInfo @operator, bool isRight, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        private void PrepareBoolConversionAndTruthOperator(TypeSymbol type, BinaryExpressionSyntax node, BinaryOperatorKind binaryOperator, CSharpBindingDiagnosticBag diagnostics,
        ...
        private static void ReportNamesMismatchesIfAny(BoundExpression left, BoundExpression right,
            ImmutableArray<string> leftNames, ImmutableArray<string> rightNames, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private TypeSymbol MakeConvertedType(ImmutableArray<TypeSymbol> convertedTypes, CSharpSyntaxNode syntax,
            ...
            bool isNullable, CSharpCompilation compilation, CSharpBindingDiagnosticBag diagnostics)
        {
