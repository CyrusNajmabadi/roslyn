...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    {
        private BoundExpression BindAnonymousObjectCreation(AnonymousObjectCreationExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        private TypeSymbol GetAnonymousTypeFieldType(BoundExpression expression, CSharpSyntaxNode errorSyntax, CSharpBindingDiagnosticBag diagnostics, ref bool hasError)
        {
