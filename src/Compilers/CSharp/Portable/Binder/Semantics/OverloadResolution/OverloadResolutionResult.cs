...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal class OverloadResolutionResult<TMember> where TMember : Symbol
    {
        ...
        private static void ReportUnsupportedMetadata(Location location, CSharpBindingDiagnosticBag diagnostics, ImmutableArray<Symbol> symbols, MemberResolutionResult<TMember> firstUnsupported)
        {
        ...
        private static void ReportWrongCallingConvention(Location location, CSharpBindingDiagnosticBag diagnostics, ImmutableArray<Symbol> symbols, MemberResolutionResult<TMember> firstSupported, MethodSymbol target)
        {
        ...
        private bool HadReturnMismatch(Location location, CSharpBindingDiagnosticBag diagnostics, TypeSymbol delegateOrFunctionPointerType)
        {
        ...
        private bool HadConstraintFailure(Location location, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private static void ReportDuplicateNamedArgument(MemberResolutionResult<TMember> result, CSharpBindingDiagnosticBag diagnostics, AnalyzedArguments arguments)
        {
        ...
        private static bool HadLambdaConversionError(CSharpBindingDiagnosticBag diagnostics, AnalyzedArguments arguments)
        {
            bool hadError = false;
        ...
        private bool HadAmbiguousWorseMethods(CSharpBindingDiagnosticBag diagnostics, ImmutableArray<Symbol> symbols, Location location, bool isQuery, BoundExpression receiver, string name)
        {
        ...
        private bool HadAmbiguousBestMethods(CSharpBindingDiagnosticBag diagnostics, ImmutableArray<Symbol> symbols, Location location)
        {
