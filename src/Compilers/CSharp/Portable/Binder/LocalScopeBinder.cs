...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class LocalScopeBinder : Binder
    {
        ...
        private bool ReportConflictWithLocal(Symbol local, Symbol newSymbol, string name, Location newLocation, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        internal virtual bool EnsureSingleDefinition(Symbol symbol, string name, Location location, CSharpBindingDiagnosticBag diagnostics)
        {
