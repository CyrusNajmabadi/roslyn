...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class Binder
    {
        ...
        private (TypeParameterConstraintClause, ArrayBuilder<TypeConstraintSyntax>?) BindTypeParameterConstraints(
            TypeParameterSyntax typeParameterSyntax, TypeParameterConstraintClauseSyntax constraintClauseSyntax, bool isForOverride, CSharpBindingDiagnosticBag diagnostics)
        {
            ...
            static void reportOverrideWithConstraints(ref bool reportedOverrideWithConstraints, TypeParameterConstraintSyntax syntax, CSharpBindingDiagnosticBag diagnostics)
            {
                if (!reportedOverrideWithConstraints)
                {
            ...
            static void reportTypeConstraintsMustBeUniqueAndFirst(CSharpSyntaxNode syntax, CSharpBindingDiagnosticBag diagnostics)
            {
            ...
            CSharpBindingDiagnosticBag diagnostics)
        {
            ...
            static bool isValidConstraintType(TypeParameterSymbol typeParameter, TypeConstraintSyntax syntax, TypeWithAnnotations typeWithAnnotations, bool performOnlyCycleSafeValidation, CSharpBindingDiagnosticBag diagnostics)
            {
