...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    {
        private delegate BoundBlock LambdaBodyFactory(LambdaSymbol lambdaSymbol, Binder lambdaBodyBinder, CSharpBindingDiagnosticBag diagnostics);
        ...
        private sealed class QueryUnboundLambdaState : UnboundLambdaState
        {
            ...
            public override void GenerateAnonymousFunctionConversionError(CSharpBindingDiagnosticBag diagnostics, TypeSymbol targetType)
            {
