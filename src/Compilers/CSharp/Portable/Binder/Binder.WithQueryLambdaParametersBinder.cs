...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class Binder
    {
        ...
        private sealed class WithQueryLambdaParametersBinder : WithLambdaParametersBinder
        {
            ...
            protected override BoundExpression BindRangeVariable(SimpleNameSyntax node, RangeVariableSymbol qv, CSharpBindingDiagnosticBag diagnostics)
            {
            ...
            private BoundExpression SelectField(SimpleNameSyntax node, BoundExpression receiver, string name, CSharpBindingDiagnosticBag diagnostics)
            {
