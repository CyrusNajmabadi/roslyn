...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal partial class Binder
    {
        ...
        /// </remarks>
        public virtual BoundStatement BindStatement(StatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundStatement BindCheckedStatement(CheckedStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            return BindEmbeddedBlock(node.Block, diagnostics);
        }

        private BoundStatement BindUnsafeStatement(UnsafeStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundStatement BindFixedStatement(FixedStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundStatement BindFixedStatementParts(FixedStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private void CheckRequiredLangVersionForIteratorMethods(YieldStatementSyntax statement, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        protected virtual void ValidateYield(YieldStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            Next?.ValidateYield(node, diagnostics);
        }

        private BoundStatement BindYieldReturnStatement(YieldStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundStatement BindYieldBreakStatement(YieldStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            if (this.Flags.Includes(BinderFlags.InFinallyBlock))
            {
                Error(diagnostics, ErrorCode.ERR_BadYieldInFinally, node.YieldKeyword);
        ...
        private BoundStatement BindLockStatement(LockStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        internal virtual BoundStatement BindLockStatementParts(CSharpBindingDiagnosticBag diagnostics, Binder originalBinder)
        {
            return this.Next.BindLockStatementParts(diagnostics, originalBinder);
        }

        private BoundStatement BindUsingStatement(UsingStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        internal virtual BoundStatement BindUsingStatementParts(CSharpBindingDiagnosticBag diagnostics, Binder originalBinder)
        {
            return this.Next.BindUsingStatementParts(diagnostics, originalBinder);
        }

        internal BoundStatement BindPossibleEmbeddedStatement(StatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            Binder binder;
        ...
        private BoundExpression BindThrownExpression(ExpressionSyntax exprSyntax, CSharpBindingDiagnosticBag diagnostics, ref bool hasErrors)
        {
        ...
        private BoundStatement BindThrow(ThrowStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundLabeledStatement BindLabeled(LabeledStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundStatement BindGoto(GotoStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            switch (node.Kind())
            {
                case SyntaxKind.GotoStatement:
        ...
        private BoundStatement BindLocalFunctionStatement(LocalFunctionStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            ...
            BoundBlock runAnalysis(BoundBlock block, CSharpBindingDiagnosticBag blockDiagnostics)
            {
                if (block != null)
                {
        ...
        public BoundStatement BindExpressionStatement(ExpressionStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            return BindExpressionStatement(node, node.Expression, node.AllowsAnyExpression, diagnostics);
        }

        private BoundExpressionStatement BindExpressionStatement(CSharpSyntaxNode node, ExpressionSyntax syntax, bool allowsAnyExpression, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </remarks>
        private void CheckForUnobservedAwaitable(BoundExpression expression, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        internal BoundStatement BindLocalDeclarationStatement(LocalDeclarationStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundStatement BindUsingDeclarationStatementParts(LocalDeclarationStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundStatement BindDeclarationStatementParts(LocalDeclarationStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        internal MethodSymbol TryFindDisposePatternMethod(BoundExpression expr, SyntaxNode syntaxNode, bool hasAwait, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private TypeWithAnnotations BindVariableTypeWithAnnotations(CSharpSyntaxNode declarationNode, CSharpBindingDiagnosticBag diagnostics, TypeSyntax typeSyntax, ref bool isConst, out bool isVar, out AliasSymbol alias)
        {
            Debug.Assert(
        ...
        internal BoundExpression BindInferredVariableInitializer(CSharpBindingDiagnosticBag diagnostics, RefKind refKind, EqualsValueClauseSyntax initializer,
        ...
        protected BoundExpression BindInferredVariableInitializer(CSharpBindingDiagnosticBag diagnostics, ExpressionSyntax initializer, BindValueKind valueKind, CSharpSyntaxNode errorSyntax)
        {
            if (initializer == null)
            {
        ...
        protected bool CheckRefLocalInAsyncOrIteratorMethod(SyntaxToken identifierToken, CSharpBindingDiagnosticBag diagnostics)
        {
            if (IsInAsyncMethod())
            {
        ...
        internal ImmutableArray<BoundExpression> BindDeclaratorArguments(VariableDeclaratorSyntax declarator, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private bool IsValidFixedVariableInitializer(TypeSymbol declType, ref BoundExpression initializerOpt, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private MethodSymbol GetFixedPatternMethodOpt(BoundExpression initializer, CSharpBindingDiagnosticBag additionalDiagnostics)
        {
        ...
        private BoundExpression BindAssignment(AssignmentExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            Debug.Assert(node != null);
        ...
        private BoundExpression InferTypeForDiscardAssignment(BoundDiscardExpression op1, BoundExpression op2, CSharpBindingDiagnosticBag diagnostics)
        {
...
#nullable disable
        ...
        internal virtual BoundBlock BindEmbeddedBlock(BlockSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            return BindBlock(node, diagnostics);
        }

        private BoundBlock BindBlock(BlockSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            if (node.AttributeLists.Count > 0)
            {
        ...
        private BoundBlock BindBlockParts(BlockSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        internal BoundExpression GenerateConversionForAssignment(TypeSymbol targetType, BoundExpression expression, CSharpBindingDiagnosticBag diagnostics, ConversionForAssignmentFlags flags = ConversionForAssignmentFlags.None)
            => GenerateConversionForAssignment(targetType, expression, diagnostics, out _, flags);

        internal BoundExpression GenerateConversionForAssignment(TypeSymbol targetType, BoundExpression expression, CSharpBindingDiagnosticBag diagnostics, out Conversion conversion, ConversionForAssignmentFlags flags = ConversionForAssignmentFlags.None)
        {
...
#nullable enable
        internal void GenerateAnonymousFunctionConversionError(CSharpBindingDiagnosticBag diagnostics, SyntaxNode syntax,
...
#nullable disable
        ...
        protected static void GenerateImplicitConversionError(CSharpBindingDiagnosticBag diagnostics, CSharpCompilation compilation, SyntaxNode syntax,
        ...
        private BoundStatement BindIfStatement(IfStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        internal BoundExpression BindBooleanExpression(ExpressionSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            // SPEC:
        ...
        private BoundStatement BindSwitchStatement(SwitchStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            Debug.Assert(node != null);
        ...
        internal virtual BoundStatement BindSwitchStatementCore(SwitchStatementSyntax node, Binder originalBinder, CSharpBindingDiagnosticBag diagnostics)
        {
            return this.Next.BindSwitchStatementCore(node, originalBinder, diagnostics);
        }

        internal virtual void BindPatternSwitchLabelForInference(CasePatternSwitchLabelSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            this.Next.BindPatternSwitchLabelForInference(node, diagnostics);
        }

        private BoundStatement BindWhile(WhileStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            Debug.Assert(node != null);
        ...
        internal virtual BoundWhileStatement BindWhileParts(CSharpBindingDiagnosticBag diagnostics, Binder originalBinder)
        {
            return this.Next.BindWhileParts(diagnostics, originalBinder);
        }

        private BoundStatement BindDo(DoStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            var loopBinder = this.GetBinder(node);
            Debug.Assert(loopBinder != null);
        ...
        internal virtual BoundDoStatement BindDoParts(CSharpBindingDiagnosticBag diagnostics, Binder originalBinder)
        {
            return this.Next.BindDoParts(diagnostics, originalBinder);
        }

        internal BoundForStatement BindFor(ForStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            var loopBinder = this.GetBinder(node);
            Debug.Assert(loopBinder != null);
        ...
        internal virtual BoundForStatement BindForParts(CSharpBindingDiagnosticBag diagnostics, Binder originalBinder)
        {
            return this.Next.BindForParts(diagnostics, originalBinder);
        }

        internal BoundStatement BindForOrUsingOrFixedDeclarations(VariableDeclarationSyntax nodeOpt, LocalDeclarationKind localKind, CSharpBindingDiagnosticBag diagnostics, out ImmutableArray<BoundLocalDeclaration> declarations)
        {
            if (nodeOpt == null)
            {
        ...
        internal BoundStatement BindStatementExpressionList(SeparatedSyntaxList<ExpressionSyntax> statements, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundStatement BindForEach(CommonForEachStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        internal virtual BoundStatement BindForEachParts(CSharpBindingDiagnosticBag diagnostics, Binder originalBinder)
        {
        ...
        /// </summary>
        internal virtual BoundStatement BindForEachDeconstruction(CSharpBindingDiagnosticBag diagnostics, Binder originalBinder)
        {
            return this.Next.BindForEachDeconstruction(diagnostics, originalBinder);
        }

        private BoundStatement BindBreak(BreakStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundStatement BindContinue(ContinueStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundStatement BindReturn(ReturnStatementSyntax syntax, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundTryStatement BindTryStatement(TryStatementSyntax node, CSharpBindingDiagnosticBag diagnostics)
        {
            Debug.Assert(node != null);
        ...
        private ImmutableArray<BoundCatchBlock> BindCatchBlocks(SyntaxList<CatchClauseSyntax> catchClauses, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundCatchBlock BindCatchBlock(CatchClauseSyntax node, ArrayBuilder<BoundCatchBlock> previousBlocks, CSharpBindingDiagnosticBag diagnostics)
        {
            bool hasError = false;
        ...
        private BoundExpression BindCatchFilter(CatchFilterClauseSyntax filter, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private void ReportCantConvertLambdaReturn(SyntaxNode syntax, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        /// </summary>
        internal BoundBlock CreateBlockFromExpression(CSharpSyntaxNode node, ImmutableArray<LocalSymbol> locals, RefKind refKind, BoundExpression expression, ExpressionSyntax expressionSyntax, CSharpBindingDiagnosticBag diagnostics)
        {
            RefKind returnRefKind;
            ...
            CSharpBindingDiagnosticBag diagnostics)
        {
            ...
            static BoundBlock bindExpressionBodyAsBlockInternal(ArrowExpressionClauseSyntax expressionBody, Binder bodyBinder, CSharpBindingDiagnosticBag diagnostics)
            {
                RefKind refKind;
        ...
        /// </summary>
        public BoundBlock BindLambdaExpressionAsBlock(ExpressionSyntax body, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        public BoundBlock CreateBlockFromExpression(ExpressionSyntax body, BoundExpression expression, CSharpBindingDiagnosticBag diagnostics)
        {
            Binder bodyBinder = this.GetBinder(body);
            Debug.Assert(bodyBinder != null);
        ...
        public virtual BoundNode BindMethodBody(CSharpSyntaxNode syntax, CSharpBindingDiagnosticBag diagnostics)
        {
            switch (syntax)
            {
        ...
        private BoundNode BindSimpleProgram(CompilationUnitSyntax compilationUnit, CSharpBindingDiagnosticBag diagnostics)
        {
            return GetBinder(compilationUnit).BindSimpleProgramCompilationUnit(compilationUnit, diagnostics);
        }

        private BoundNode BindSimpleProgramCompilationUnit(CompilationUnitSyntax compilationUnit, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundNode BindPrimaryConstructorBody(TypeDeclarationSyntax typeDecl, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        internal virtual BoundExpressionStatement BindConstructorInitializer(PrimaryConstructorBaseTypeSyntax initializer, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private BoundNode BindConstructorBody(ConstructorDeclarationSyntax constructor, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        internal virtual BoundExpressionStatement BindConstructorInitializer(ConstructorInitializerSyntax initializer, CSharpBindingDiagnosticBag diagnostics)
        {
            BoundExpression initializerInvocation = GetBinder(initializer).BindConstructorInitializer(initializer.ArgumentList, (MethodSymbol)this.ContainingMember(), diagnostics);
...
#nullable enable
        internal BoundExpressionStatement? BindImplicitConstructorInitializer(SyntaxNode ctorSyntax, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        internal static BoundExpression? BindImplicitConstructorInitializer(
            MethodSymbol constructor, CSharpBindingDiagnosticBag diagnostics, CSharpCompilation compilation)
        {
        ...
        internal static BoundCall? GenerateBaseParameterlessConstructorInitializer(MethodSymbol constructor, CSharpBindingDiagnosticBag diagnostics)
        {
        ...
        private static BoundCall? GenerateBaseCopyConstructorInitializer(SynthesizedRecordCopyCtor constructor, CSharpBindingDiagnosticBag diagnostics)
        {
            NamedTypeSymbol containingType = constructor.ContainingType;
            NamedTypeSymbol baseType = containingType.BaseTypeNoUseSiteDiagnostics;
            Location diagnosticsLocation = constructor.GetFirstLocationOrNone();
...
#nullable disable
        ...
        private BoundNode BindMethodBody(CSharpSyntaxNode declaration, BlockSyntax blockBody, ArrowExpressionClauseSyntax expressionBody, CSharpBindingDiagnosticBag diagnostics)
        {
