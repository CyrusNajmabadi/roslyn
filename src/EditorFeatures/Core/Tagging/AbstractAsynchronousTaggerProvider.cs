...
internal abstract partial class AbstractAsynchronousTaggerProvider<TTag> where TTag : ITag
{
    ...
    /// <summary>
    /// Whether or not this tagger would like to use frozen snapshots to compute tags. If <see
    ...
    /// continuously be getting frozen results quickly, but always with the final, full, correct results coming
    /// at the end once enough idle time has passed.
    /// </summary>
    protected virtual bool SupportsFrozenSemantics => false;
