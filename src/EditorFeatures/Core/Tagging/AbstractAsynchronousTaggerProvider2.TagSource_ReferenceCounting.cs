...
{
    internal partial class AbstractAsynchronousTaggerProvider2<TTag>
    {
...
{_stackTrace}");
            ...
            internal void OnTaggerDisposed()
            {
                _provider.AssertIsForeground();
            ...
            internal void TestOnly_Dispose1()
            {
                _provider.AssertIsForeground();
                Dispose();
            }
