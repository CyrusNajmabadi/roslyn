...
internal sealed class CSharpImplementInterfaceCodeFixProvider() : AbstractImplementInterfaceCodeFixProvider<TypeSyntax>()
{
    ...
    protected override bool IsTypeInBaseTypeList(TypeSyntax typeSyntax)
        => typeSyntax.Parent is BaseTypeSyntax syntax && typeSyntax.Parent.Parent is BaseListSyntax && syntax.Type == typeSyntax;
}
