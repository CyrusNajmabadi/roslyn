...
{
    private bool HasConflictingMember(IImplementInterfaceInfo state, ISymbol member, ArrayBuilder<ISymbol> implementedVisibleMembers)
    {
        ...
        var conflict2 = IsReservedName(state, member.Name);
